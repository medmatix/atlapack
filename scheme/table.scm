...
(foreign-library
 ...
 (callback-typedefs
  (lapack_logical LAPACK_S_SELECT2 (float* float*))
  (lapack_logical LAPACK_S_SELECT3 (float* float* float*))
  (lapack_logical LAPACK_D_SELECT2 (double* double*))
  (lapack_logical LAPACK_D_SELECT3 (double* double* double*))
  (lapack_logical LAPACK_C_SELECT1 (lapack_complex_float*))
  (lapack_logical LAPACK_C_SELECT2 (lapack_complex_float* lapack_complex_float*))
  (lapack_logical LAPACK_Z_SELECT1 (lapack_complex_double*))
  (lapack_logical LAPACK_Z_SELECT2 (lapack_complex_double* lapack_complex_double*)))
 (functions
  ...
  (lapack_int LAPACKE_sdisna (char job lapack_int m lapack_int n float* d float* sep))
  (lapack_int LAPACKE_ddisna (char job lapack_int m lapack_int n double* d double* sep))
...
;;; these are available only when XBLAS is used
